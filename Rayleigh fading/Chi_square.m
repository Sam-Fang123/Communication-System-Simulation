...
xlim([0 8])
hold on
plot( x1, exp(-x1/2/(1/2))/gamma(1)/(1/2)/2 ,'b-','LineWidth',2);
hold off
...
xlim([0 8])
hold on
plot( x1, exp(-x1/2/(1/2)).*x1.^(4/2-1)/(2^(4/2))/gamma(4/2)/sqrt(1/2)^4 ,'b-','LineWidth',2);
hold off
...
xlim([0 8])
hold on
plot( x1, exp(-x1/2/(1/2)).*x1.^(8/2-1)/(2^(8/2))/gamma(8/2)/sqrt(1/2)^8 ,'b-','LineWidth',2);
hold off
