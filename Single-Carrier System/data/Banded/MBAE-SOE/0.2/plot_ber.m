...
%legend('D=1(MBAE) O-GCE','D=1(MBAE) OW-GCE','D=1(MBAE) Ideal')
%legend('D=2(MBAE) O-GCE','D=2(MBAE) OW-GCE','D=2(MBAE) Ideal')
%legend('D=3(MBAE) O-GCE','D=3(MBAE) OW-GCE','D=3(MBAE) Ideal')
legend('D=4(MBAE) O-GCE','D=4(MBAE) OW-GCE','D=4(MBAE) Ideal')
xlim([0 indv.range(end)]);
%ylim([10^-3 0.5]);
xticks(indv.range)
