load('D&E-mode_indv=SNR_Tang_ZP_Optiaml_GCE-BEM_MMSE_IBDFE_TV_1st_banded_Q=1_D_FF=3_D_FB_full_QPSK_fd=0.02_N=256_I=3_M=5_Nblock=10000.mat')
dv4=dv;
load('D&E-mode_indv=SNR_Tang_ZP_Optiaml_GCE-BEM_MMSE_IBDFE_TV_1st_banded_Q=1_D_FF=2_D_FB_full_QPSK_fd=0.02_N=256_I=3_M=5_Nblock=10000.mat')
dv3=dv;
load('D&E-mode_indv=SNR_Tang_ZP_Optiaml_GCE-BEM_MMSE_IBDFE_TV_1st_banded_Q=1_D_FF=1_D_FB_full_QPSK_fd=0.02_N=256_I=3_M=5_Nblock=10000.mat')
dv2=dv;
...
ylim([10^-6 1]);
xticks(indv.range)
title('QPSK BER using Estimated CSI(Normalized Doppler Frequency=0.02)')
