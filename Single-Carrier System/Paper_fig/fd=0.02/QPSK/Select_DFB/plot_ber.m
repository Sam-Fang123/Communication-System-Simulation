...
dv6=dv;
load('D&E-mode_indv=SNR_Tang_ZP_Optiaml_GCE-BEM_MMSE_IBDFE_TV_1st_banded_Q=1_D_FF=0_D_FB=1_QPSK_fd=0.02_N=256_I=3_M=5_Nblock=10000.mat')
dv5=dv;
load('D&E-mode_indv=SNR_Tang_ZP_Optiaml_GCE-BEM_MMSE_IBDFE_TV_1st_banded_Q=1_D_FF=0_D_FB=0_QPSK_fd=0.02_N=256_I=3_M=5_Nblock=10000.mat')
dv4=dv;
load('D&E-mode_indv=SNR_No-windowing_ZP_Optiaml_GCE-BEM_MMSE_MMSE_FD_LE_full_QPSK_fd=0.02_N=256_I=3_M=5_Nblock=10000.mat')
dv2=dv;
load('D&E-mode_indv=SNR_No-windowing_ZP_Optiaml_GCE-BEM_MMSE_IBDFE_TI_QPSK_fd=0.02_N=256_I=3_M=5_Nblock=10000.mat')
...
title('QPSK BER using Estimated CSI (Normalized Doppler Frequency = 0.02), IBDFE-TV D_F_F=0')
