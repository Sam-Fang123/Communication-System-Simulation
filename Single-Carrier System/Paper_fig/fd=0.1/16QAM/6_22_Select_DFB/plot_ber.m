...
dv7=dv;
load('D&E-mode_indv=SNR_Tang_ZP_Optiaml_GCE-BEM_MMSE_IBDFE_TV_1st_banded_Q=2_D_FF=1_D_FB=3_16QAM_fd=0.1_N=256_I=5_M=5_Nblock=10000.mat')
dv6=dv;
...
dv5=dv;
load('D&E-mode_indv=SNR_Tang_ZP_Optiaml_GCE-BEM_MMSE_IBDFE_TV_1st_banded_Q=2_D_FF=1_D_FB=1_16QAM_fd=0.1_N=256_I=5_M=5_Nblock=10000.mat')
dv4=dv;
dv3=dv;
load('D&E-mode_indv=SNR_No-windowing_ZP_Optiaml_GCE-BEM_MMSE_MMSE_FD_LE_full_16QAM_fd=0.1_N=256_I=5_M=5_Nblock=10000.mat')
dv2=dv;
load('D&E-mode_indv=SNR_No-windowing_ZP_Optiaml_GCE-BEM_MMSE_IBDFE_TI_16QAM_fd=0.1_N=256_I=5_M=5_Nblock=10000.mat')
figure(2)
...
title('16QAM BER using Estimated CSI (Normalized Doppler Frequency = 0.1), IBDFE-TV D_F_F=1')
