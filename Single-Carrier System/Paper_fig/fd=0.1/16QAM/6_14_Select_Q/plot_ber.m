...
dv4=dv;
load('D&E-mode_indv=SNR_Tang_ZP_Optiaml_GCE-BEM_MMSE_MMSE_FD_LE_banded_Q=3_16QAM_fd=0.1_N=256_I=5_M=5_Nblock=10000.mat')
dv3=dv;
load('D&E-mode_indv=SNR_Tang_ZP_Optiaml_GCE-BEM_MMSE_MMSE_FD_LE_banded_Q=2_16QAM_fd=0.1_N=256_I=5_M=5_Nblock=10000.mat')
dv2=dv;
load('D&E-mode_indv=SNR_Tang_ZP_Optiaml_GCE-BEM_MMSE_MMSE_FD_LE_banded_Q=1_16QAM_fd=0.1_N=256_I=5_M=5_Nblock=10000.mat')
