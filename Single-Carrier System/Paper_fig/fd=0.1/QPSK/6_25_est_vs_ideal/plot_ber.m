...
semilogy(indv.range,dv2.BER_ideal(1,:),'--o');
semilogy(indv.range,dv2.BER_ideal(3,:),'--s');
semilogy(indv.range,dv3.BER_ideal(3,:),'--*');
title('QPSK BER (Normalized Doppler Frequency = 0.1), IBDFE-TV D_F_F=1')
legend('Full-MMSE-LE, no windowing','Banded-MMSE-LE Q=2 [6]', ...
    'IBDFE-TV D_F_B=1, 1st iteration use Banded-MMSE-LE Q=2 [6], 3th iteration',...
    ...
    'IBDFE-TV D_F_B=1, 1st iteration use Banded-MMSE-LE Q=2 [6], 3th iteration (Perfect CSI)',...
